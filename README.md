...
|-------|-----------|--------|----------|
| ACCOUNT| 0.78      | 0.78   | 0.78     |
| DELIVERY | 0.61      | 0.57   | 0.59     |
| ORDER | 0.72      | 0.74   | 0.73     |
| REFUND | 0.74      | 0.72   | 0.73     |
| SHIPPING_ADDRESS | 0.67      | 0.71   | 0.69     |
...
| Class | Precision | Recall | F1-score |
|-------|-----------|--------|----------|
| ACCOUNT| 0.80      | 0.77   | 0.78     |
| DELIVERY | 0.60      | 0.57   | 0.58     |
| ORDER | 0.73      | 0.76   | 0.75     |
| REFUND | 0.71      | 0.72   | 0.71     |
| SHIPPING_ADDRESS | 0.66      | 0.69   | 0.68     |
| **Macro Avg** | **0.70** | **0.70** | **0.70** |
| **Weighted Avg** | **0.70** | **0.70** | **0.70** |
...
|-------|-----------|--------|----------|
| ACCOUNT| 0.78      | 0.78   | 0.78     |
| DELIVERY | 0.57      | 0.58   | 0.57     |
| ORDER | 0.74      | 0.70   | 0.72     |
| REFUND | 0.59      | 0.59   | 0.59     |
| SHIPPING_ADDRESS | 0.47      | 0.48   | 0.48     |
...
| Class | Precision | Recall | F1-score |
|-------|-----------|--------|----------|
| ACCOUNT| 0.62      | 0.87   | 0.72     |
| DELIVERY | 0.53      | 0.29   | 0.38     |
| ORDER | 0.72      | 0.68   | 0.70     |
| REFUND | 0.47      | 0.68   | 0.56     |
| SHIPPING_ADDRESS | 0.60      | 0.39   | 0.47     |
